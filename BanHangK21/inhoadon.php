  ...
  <div style="margin:0 auto; width:700px; border:1px solid #000;">
    ...
    <table width="100%" style="margin-left: 20px">
      ...
      <tr>
        ...
        <td><?php echo "Email: ".$row1['Email'];?><td>
      </tr>
      <tr>
        <td><?php echo "Ngày giao hàng: ".date("d/m/Y"); ?></td>
        <td><?php echo "Phương thức thanh toán: ".$row1['PhuongThuc'];?><td>
      </tr>
    </table>
    <table width="95%" style="border-collapse:collapse; margin-left: 20px; margin-right: 20px;">
        <tr>
          <td width="5%" bgcolor="#CCCCCC"  align="center" style="border:1px solid #000;"><div align="center"><b>STT</b></div></td>
          <td width="10%" bgcolor="#CCCCCC"  align="center" style="border:1px solid #000;"><div align="center"><b>Mã sản phẩm</b></div></td>
          <td width="25%" bgcolor="#CCCCCC"  align="center" style="border:1px solid #000;"><div align="center"><b>Tên sản phẩm</b></div></td>
          <td width="5%" bgcolor="#CCCCCC"  align="center" style="border:1px solid #000;"><div align="center"><b>ĐVT</b></div></td>
          <td width="5%" bgcolor="#CCCCCC"  align="center" style="border:1px solid #000;"><div align="center"><b>Số lượng</b></div></td>
          <td width="12%" bgcolor="#CCCCCC"  align="center" style="border:1px solid #000;"><div align="center"><b>Đơn giá VNĐ</b></div></td>            
      ...
      <tr>
        ...
        <td align="center" style="border:1px solid #000;"><?php echo $row['DonViTinh']?></td>
    ...
    <?php } $vat = $tong * 0.1; 
      ...
      <tr style="border:1px solid #000;">
        ...
        <I><?php echo ucfirst(convert_number_to_words($tongcong)); ?></I></td>
      </tr>
      <tr>
