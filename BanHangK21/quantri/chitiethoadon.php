...
?>
        <div class="quanlysp">
            ...
            <p style="margin-left: 33%; margin-top: 50px;"><?php echo "Tên khách hàng: " . $row1['TenKhachHang'];
                                                            echo "</br>"; ?></p>
            <p style="margin-left: 33%;"><?php echo "Địa chỉ: " . $row1['DiaChi'] . " ";
                                            echo "</br>"; ?></p>
            <p style="margin-left: 33%;"><?php echo "Điện thoại: 0" . $row1['SoDienThoai'];
                                            echo "</br>"; ?></p>
            <p style="margin-left: 33%;"><?php echo "Ngày đặt hàng: " . $row1['NgayBan'];
                                            echo "</br>"; ?></p>
        ...
        <div>
            ...
            <p style="float:right; margin-top:10px; margin-left: 200px; text-decoration: none;">
                <a href="./Quantri/xoa_don_hang.php?admin=xoaDH&IDHoaDon=<?php echo $id ?>" target="_self">Xóa đơn hàng</a>
            </p>
            </script>
            <p style="float:right; margin-top:10px; margin-left: 220px; text-decoration: none;"><a href="./Quantri/inhoadon.php?admin=inHD&IDHoaDon=<?php echo $id ?>" target="_blank">In hoá đơn</a></p>
            <?php
            ?>
        </div>
